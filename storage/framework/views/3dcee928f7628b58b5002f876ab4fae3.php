<div class="min-h-screen flex flex-col" 
     x-data="{ 
        ...
        media: <?php echo \Illuminate\Support\Js::from($media)->toHtml() ?>,
        showMedia: <?php echo \Illuminate\Support\Js::from($showMedia)->toHtml() ?>,
        rotationSpeed: <?php echo \Illuminate\Support\Js::from($rotationSpeed * 1000)->toHtml() ?>,
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-700 py-6 px-8 shadow-2xl">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-4">
                    <!--[if BLOCK]><![endif]--><?php if($logo): ?>
                        <img src="<?php echo e(Storage::url($logo)); ?>" alt="Logo" class="h-20 w-20 object-contain bg-white rounded-lg p-2">
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <div>
                        <h1 class="text-4xl font-bold text-white myanmar-text"><?php echo e($appName); ?></h1>
            ...
            <!--[if BLOCK]><![endif]--><?php if($promotionalMessage): ?>
    ...
    <div x-show="!showingMedia" class="bg-gray-800 py-4 px-8 shadow-lg">
        <div class="max-w-7xl mx-auto">
            <div class="flex space-x-3 overflow-x-auto">
                ...
                <button 
                    @click="currentIndex = <?php echo e($index); ?>"
                    :class="currentIndex === <?php echo e($index); ?> ? 'bg-primary-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'"
                    class="px-6 py-3 rounded-lg font-semibold transition-all duration-300 whitespace-nowrap">
                    <span class="myanmar-text"><?php echo e($category['name_mm'] ?? $category['name']); ?></span>
                    <span class="ml-2 text-sm opacity-75">(<?php echo e($category['items_count']); ?>)</span>
                </button>
    ...
    <div x-show="!showingMedia" class="flex-1 overflow-y-auto py-8 px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div x-show="currentIndex === <?php echo e($index); ?>" 
                ...
                <!--[if BLOCK]><![endif]--><?php if(isset($items[$category['id']])): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $items[$category['id']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-gray-800 rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-bold text-white mb-1 myanmar-text truncate">
                                <?php echo e($item['name_mm'] ?? $item['name']); ?>

                            </h3>
                            <p class="text-sm text-gray-400 mb-3 truncate"><?php echo e($item['name']); ?></p>
                            
                            <!--[if BLOCK]><![endif]--><?php if($showDescriptions && (isset($item['description_mm']) || isset($item['description']))): ?>
                            <p class="text-sm text-gray-300 mb-3 line-clamp-2 myanmar-text">
                                <?php echo e($item['description_mm'] ?? $item['description'] ?? ''); ?>

                            </p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            
                            <div class="flex items-center justify-between">
                                <!--[if BLOCK]><![endif]--><?php if($showPrices): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($showAvailability): ?>
    ...
    <div x-show="!showingMedia" class="bg-gray-800 py-4 px-8 border-t border-gray-700">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <span class="text-gray-600">|</span>
                <span class="text-gray-400 text-sm">© <?php echo e(date('Y')); ?> <?php echo e($appName); ?></span>
            </div>
        </div>
    </div>
    ...
    <?php
        $__scriptKey = '3305470517-0';
        ob_start();
    ?>
<script>
    // Livewire polling for real-time updates
    setInterval(() => {
        window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('loadData');
    ...
    ?>
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/display/menu-board-enhanced.blade.php ENDPATH**/ ?>