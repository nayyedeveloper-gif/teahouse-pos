<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <a href="<?php echo e(route('waiter.tables.index')); ?>" class="btn btn-primary">
        ...
        <div class="space-y-4">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card hover:shadow-md transition-shadow cursor-pointer" wire:click="viewOrder(<?php echo e($order->id); ?>)">
                    <div class="card-body">
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/waiter/orders-list.blade.php ENDPATH**/ ?>