    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="flex justify-center p-8 bg-gray-50 rounded-lg">
                <?php echo QrCode::size(300)->generate($menuUrl); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex">
                        <input type="text" value="<?php echo e($menuUrl); ?>" readonly class="input flex-1 bg-gray-50">
                        <button onclick="copyToClipboard('<?php echo e($menuUrl); ?>')" class="ml-2 btn btn-outline">
                ...
                <!-- Preview Button -->
                <a href="<?php echo e($menuUrl); ?>" target="_blank" class="w-full btn btn-success">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/admin/qr-menu-management.blade.php ENDPATH**/ ?>