<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 myanmar-text">မင်္ဂလာပါ, <?php echo e(auth()->user()->name); ?></h1>
            ...
            <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2"><?php echo e($todayStats['active']); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2"><?php echo e($todayStats['completed']); ?></p>
                    </div>
                    <div class="bg-white bg-opacity-30 rounded-full p-3">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2"><?php echo e($todayStats['total_orders']); ?></p>
                    </div>
                    <div class="bg-white bg-opacity-30 rounded-full p-3">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <a href="<?php echo e(route('waiter.tables.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-2 border-green-200 hover:border-green-400">
            ...
            <a href="<?php echo e(route('waiter.orders.create', ['type' => 'takeaway'])); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-2 border-blue-200 hover:border-blue-400">
                <div class="flex items-center">
            ...
            <a href="<?php echo e(route('waiter.orders.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-2 border-purple-200 hover:border-purple-400">
                <div class="flex items-center">
        ...
        <!-- Active Orders -->
        <!--[if BLOCK]><![endif]--><?php if($activeOrders->count() > 0): ?>
        <div class="mb-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xl font-bold text-gray-900 myanmar-text">လက်ရှိ အော်ဒါများ</h2>
                <a href="<?php echo e(route('waiter.orders.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800 myanmar-text">အားလုံးကြည့်ရန် →</a>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $activeOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-xl shadow-md p-4 border-l-4 border-yellow-500">
                    ...
                    <div class="flex items-center text-sm text-gray-600 mb-2">
                        ...
                        <?php echo e($order->table->name); ?> - <span class="myanmar-text"><?php echo e($order->table->name_mm); ?></span>
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-200">
                        <span class="font-bold text-gray-900"><?php echo e(number_format($order->total, 0)); ?> Ks</span>
                        <a href="<?php echo e(route('waiter.orders.create', ['order' => $order->id])); ?>" class="text-xs text-blue-600 hover:text-blue-800 myanmar-text">
                            ထပ်ထည့်မည် →
                        </a>
                    </div>
                </div>
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/waiter/dashboard.blade.php ENDPATH**/ ?>