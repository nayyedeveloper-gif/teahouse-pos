<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-gray-900"><?php echo e(number_format($todaySales, 0)); ?> Ks</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-gray-900"><?php echo e($todayOrders); ?></dd>
                            <dd class="text-xs text-gray-500 myanmar-text">ပြီးသွားသော: <?php echo e($completedOrdersToday); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-gray-900"><?php echo e($totalItems); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-gray-900"><?php echo e($occupiedTables); ?>/<?php echo e($totalTables); ?></dd>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-red-600"><?php echo e(number_format($todayExpenses, 0)); ?> Ks</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-orange-600"><?php echo e(number_format($monthlyExpenses, 0)); ?> Ks</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-purple-600"><?php echo e(number_format($todayGrossProfit, 0)); ?> Ks</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0 <?php echo e($todayNetProfit >= 0 ? 'bg-green-500' : 'bg-red-500'); ?> rounded-md p-3">
                        <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <!--[if BLOCK]><![endif]--><?php if($todayNetProfit >= 0): ?>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate myanmar-text">
                                <?php echo e($todayNetProfit >= 0 ? 'အမြတ်' : 'အရှုံး'); ?>

                            </dt>
                            <dd class="text-lg font-semibold <?php echo e($todayNetProfit >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                <?php echo e(number_format(abs($todayNetProfit), 0)); ?> Ks
                            </dd>
                        </dl>
                    </div>
                </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-blue-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-blue-600"><?php echo e(number_format($todaySubtotal, 0)); ?> Ks</p>
                        </div>
                ...
                <div class="bg-indigo-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-indigo-600"><?php echo e(number_format($todayTax, 0)); ?> Ks</p>
                        </div>
                ...
                <div class="bg-teal-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-teal-600"><?php echo e(number_format($todayServiceCharge, 0)); ?> Ks</p>
                        </div>
                ...
                <div class="bg-yellow-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-yellow-600"><?php echo e(number_format($todayDiscount, 0)); ?> Ks</p>
                        </div>
                ...
                <div class="bg-pink-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-pink-600"><?php echo e(number_format($todayFOC, 0)); ?> Ks</p>
                        </div>
                ...
                <div class="bg-green-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-green-600"><?php echo e(number_format($todaySales, 0)); ?> Ks</p>
                        </div>
                ...
                <div class="bg-red-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-red-600"><?php echo e(number_format($todayExpenses, 0)); ?> Ks</p>
                        </div>
                ...
                <!-- Net Profit -->
                <div class="bg-<?php echo e($todayNetProfit >= 0 ? 'emerald' : 'rose'); ?>-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 myanmar-text"><?php echo e($todayNetProfit >= 0 ? 'အမြတ်' : 'အရှုံး'); ?> (Net)</p>
                            <p class="text-xl font-bold text-<?php echo e($todayNetProfit >= 0 ? 'emerald' : 'rose'); ?>-600"><?php echo e(number_format(abs($todayNetProfit), 0)); ?> Ks</p>
                        </div>
                        <svg class="w-8 h-8 text-<?php echo e($todayNetProfit >= 0 ? 'emerald' : 'rose'); ?>-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <!--[if BLOCK]><![endif]--><?php if($todayNetProfit >= 0): ?>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            <?php else: ?>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
    ...
    <!--[if BLOCK]><![endif]--><?php if($pendingOrders > 0): ?>
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-orange-700">
                    ...
                    <span class="myanmar-text">စောင့်ဆိုင်းနေသော အော်ဒါ <?php echo e($pendingOrders); ?> ခု ရှိပါသည်။</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <div class="space-y-3">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $topSellingItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center justify-between border-b border-gray-100 pb-2">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900 myanmar-text"><?php echo e($item->name_mm); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($item->name); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-sm font-semibold text-gray-900"><?php echo e($item->total_quantity); ?> <span class="myanmar-text">ခု</span></p>
                            <p class="text-xs text-gray-500"><?php echo e(number_format($item->total_sales, 0)); ?> Ks</p>
                        </div>
                    </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <!--[if BLOCK]><![endif]--><?php if($salesByCategory->count() > 0): ?>
                <div class="space-y-3">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $salesByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center justify-between border-b border-gray-100 pb-2">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900 myanmar-text"><?php echo e($category->name_mm); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($category->name); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-sm font-semibold text-gray-900"><?php echo e(number_format($category->total_sales, 0)); ?> Ks</p>
                            <p class="text-xs text-gray-500 myanmar-text"><?php echo e($category->order_count); ?> အော်ဒါ</p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            <!--[if BLOCK]><![endif]--><?php if($recentOrders->count() > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($order->table): ?>
                                    <span class="myanmar-text"><?php echo e($order->table->name); ?></span>
                                <?php else: ?>
                                    <span class="myanmar-text">ပါဆယ်ယူမည်</span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <span class="myanmar-text"><?php echo e($order->order_type === 'dine_in' ? 'ဆိုင်တွင်းစားမည်' : 'ပါဆယ်ယူမည်'); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(number_format($order->total, 0)); ?> Ks
                            </td>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="<?php echo e(route('admin.expenses.index')); ?>" class="text-sm text-primary-600 hover:text-primary-800 myanmar-text">အားလုံးကြည့်ရန် →</a>
            </div>
            <!--[if BLOCK]><![endif]--><?php if($recentExpenses->count() > 0): ?>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentExpenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-red-600">
                                <?php echo e(number_format($expense->amount, 0)); ?> Ks
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6">
        <div class="p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="<?php echo e(route('admin.items.index')); ?>" class="btn btn-outline text-center">
                    <svg class="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                    <span class="myanmar-text">ပစ္စည်းများ</span>
                </a>
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="btn btn-outline text-center">
                    <svg class="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                    </svg>
                    <span class="myanmar-text">အမျိုးအစားများ</span>
                </a>
                <a href="<?php echo e(route('admin.tables.index')); ?>" class="btn btn-outline text-center">
                    <svg class="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                    </svg>
                    <span class="myanmar-text">စားပွဲများ</span>
                </a>
                <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-outline text-center">
                    <svg class="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/admin/dashboard.blade.php ENDPATH**/ ?>