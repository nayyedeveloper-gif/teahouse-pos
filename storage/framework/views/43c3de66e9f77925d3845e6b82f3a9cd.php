        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $stockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($item->name); ?></div>
                            <!--[if BLOCK]><![endif]--><?php if($item->name_mm): ?>
                            <div class="text-sm text-gray-500 myanmar-text"><?php echo e($item->name_mm); ?></div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($item->sku ?? '-'); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-900"><?php echo e($item->unit); ?></td>
                        <td class="px-6 py-4 text-right">
                            <span class="text-sm font-medium <?php echo e($item->is_low_stock ? 'text-red-600' : 'text-gray-900'); ?>">
                                <?php echo e(number_format($item->current_stock, 2)); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 text-right text-sm text-gray-900"><?php echo e(number_format($item->minimum_stock, 2)); ?></td>
                        <td class="px-6 py-4 text-right text-sm text-gray-900"><?php echo e(number_format($item->unit_cost)); ?> Ks</td>
                        <td class="px-6 py-4 text-sm">
                            <button wire:click="edit(<?php echo e($item->id); ?>)" class="text-primary-600 hover:text-primary-900 mr-3">Edit</button>
                            <button wire:click="delete(<?php echo e($item->id); ?>)" wire:confirm="ဖျက်မှာ သေချာပါသလား?" class="text-red-600 hover:text-red-900">Delete</button>
                        </td>
                    </tr>
            ...
            <div class="px-6 py-4"><?php echo e($stockItems->links()); ?></div>
        </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['current_stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['minimum_stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-span-2">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['unit_cost'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/admin/inventory/stock-item-management.blade.php ENDPATH**/ ?>