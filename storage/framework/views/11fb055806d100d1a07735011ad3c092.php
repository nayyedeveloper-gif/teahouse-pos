    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="flex justify-center mb-4">
                ...
                ?>
                <?php if($logo): ?>
                    <img src="<?php echo e(Storage::url($logo)); ?>" alt="Logo" class="h-20 w-20 object-contain">
                <?php else: ?>
            ...
            <h1 class="text-3xl font-bold text-gray-900 myanmar-text"><?php echo e(App\Models\Setting::get('app_name', config('app.name'))); ?></h1>
        ...
        <div class="text-center mt-6 text-sm text-gray-600">
            <p class="myanmar-text">© <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/auth/login.blade.php ENDPATH**/ ?>