...
<body class="bg-gradient-to-br from-primary-50 to-primary-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <!-- Actions -->
            <div class="space-y-3">
                <a href="<?php echo e(route('dashboard')); ?>" class="block w-full btn btn-primary">
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/errors/404.blade.php ENDPATH**/ ?>