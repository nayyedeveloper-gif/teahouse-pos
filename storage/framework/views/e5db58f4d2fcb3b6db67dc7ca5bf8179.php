<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2"><?php echo e($todayStats['pending']); ?></p>
            ...
            <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2"><?php echo e($todayStats['completed_today']); ?></p>
            ...
            <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-2"><?php echo e(number_format($todayStats['total_sales'], 0)); ?></p>
            ...
            <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-2"><?php echo e(number_format($todayStats['average_sale'], 0)); ?></p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <a href="<?php echo e(route('cashier.pos')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-2 border-green-200 hover:border-green-400">
            ...
            <a href="<?php echo e(route('cashier.orders.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-2 border-yellow-200 hover:border-yellow-400">
                <div class="flex items-center">
            ...
            <a href="<?php echo e(route('cashier.orders.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-2 border-blue-200 hover:border-blue-400">
                <div class="flex items-center">
        ...
        <!-- Pending Orders -->
        <!--[if BLOCK]><![endif]--><?php if($pendingOrders->count() > 0): ?>
        <div class="mb-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-semibold">
                    <?php echo e($pendingOrders->count()); ?> <span class="myanmar-text">ခု</span>
                </span>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $pendingOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 cursor-pointer" onclick="window.location='<?php echo e(route('cashier.orders.index')); ?>''">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    <?php echo e($order->orderItems->count()); ?> <span class="myanmar-text">မျိုး</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-bold text-gray-900"><?php echo e(number_format($order->total, 0)); ?> Ks</div>
                                </td>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-white rounded-xl shadow-md p-4 border-l-4 border-green-500">
                    <div class="flex items-center justify-between mb-2">
                        <span class="font-bold text-gray-900"><?php echo e($sale->order_number); ?></span>
                        <span class="text-xs text-gray-500"><?php echo e($sale->completed_at ? $sale->completed_at->format('H:i') : $sale->created_at->format('H:i')); ?></span>
                    </div>
                    <!--[if BLOCK]><![endif]--><?php if($sale->table): ?>
                    <div class="text-sm text-gray-600 mb-2">
                        <span class="myanmar-text">စားပွဲ:</span> <?php echo e($sale->table->name); ?>

                    </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-200">
                        <span class="text-sm text-gray-600 myanmar-text">စုစုပေါင်း</span>
                        <span class="font-bold text-green-600"><?php echo e(number_format($sale->total, 0)); ?> Ks</span>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
            </div>
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/cashier/dashboard.blade.php ENDPATH**/ ?>