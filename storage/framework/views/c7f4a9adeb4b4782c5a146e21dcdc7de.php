                ...
                <!--[if BLOCK]><![endif]--><?php if(isset($items[$category['id']])): ?>
                    ...
                    <div class="bg-gray-800 rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                        ...
                        <div class="p-4">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(isset($item['description_mm']) || isset($item['description'])): ?>
...
<script>
    ...
    ?>
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/display/menu-board.blade.php ENDPATH**/ ?>