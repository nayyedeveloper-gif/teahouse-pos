                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-gray-900 myanmar-text"><?php echo e($order->table->name_mm); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e($order->table->name); ?></div>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-3">
                                <button wire:click="viewOrder(<?php echo e($order->id); ?>)" class="text-indigo-600 hover:text-indigo-900 myanmar-text">
                                    ကြည့်ရန်
                                </button>
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/admin/orders-management.blade.php ENDPATH**/ ?>