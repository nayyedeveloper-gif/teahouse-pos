                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-medium text-gray-900"><?php echo e($customer->customer_code); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($customer->name); ?></div>
                                <!--[if BLOCK]><![endif]--><?php if($customer->name_mm): ?>
                                <div class="text-sm text-gray-500 myanmar-text"><?php echo e($customer->name_mm); ?></div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm text-gray-900"><?php echo e($customer->phone); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                    <?php echo e(number_format($customer->loyalty_points)); ?> pts
                                </span>
                                <div class="text-xs text-gray-500 mt-1">
                                    ≈ <?php echo e(number_format($customer->points_value)); ?> Ks
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-medium text-gray-900"><?php echo e(number_format($customer->total_spent)); ?> Ks</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm text-gray-900"><?php echo e($customer->visit_count); ?> ကြိမ်</span>
                                <!--[if BLOCK]><![endif]--><?php if($customer->last_visit_at): ?>
                                <div class="text-xs text-gray-500"><?php echo e($customer->last_visit_at->diffForHumans()); ?></div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button wire:click="edit(<?php echo e($customer->id); ?>)" class="text-primary-600 hover:text-primary-900 mr-3">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </button>
                                <button wire:click="delete(<?php echo e($customer->id); ?>)" wire:confirm="ဖောက်သည်ကို ဖျက်မှာ သေချာပါသလား?" class="text-red-600 hover:text-red-900">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <form wire:submit.prevent="save">
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <h3 class="text-lg font-medium text-gray-900 mb-4 myanmar-text">
                                <?php echo e($editMode ? 'ဖောက်သည် ပြင်ဆင်ရန်' : 'ဖောက်သည်အသစ် ထည့်ရန်'); ?>
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/admin/customer-management.blade.php ENDPATH**/ ?>