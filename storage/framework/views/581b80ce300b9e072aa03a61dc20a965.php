<div wire:poll.5s>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden border-2 
            <?php if($table->status === 'available'): ?> border-green-200
            <?php elseif($table->status === 'occupied'): ?> border-red-200
            <?php else: ?> border-yellow-200
            <?php endif; ?>
            hover:shadow-md transition-shadow">
            <div class="p-6">
                <div class="flex justify-between items-start mb-4">
                    <div class="flex-1">
                        <h3 class="text-xl font-bold text-gray-900 myanmar-text"><?php echo e($table->name_mm); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e($table->name); ?></p>
                    </div>
                    <div>
                        <!--[if BLOCK]><![endif]--><?php if($table->status === 'available'): ?>
                ...
                <div class="space-y-3 mb-4">
                    <div class="flex items-center text-sm">
                        ...
                        <span class="ml-2 font-medium"><?php echo e($table->capacity); ?> <span class="myanmar-text">ဦး</span></span>
                    </div>
                    ...
                    <div class="flex items-center text-sm">
                        ...
                        <span class="ml-2 font-medium"><?php echo e($table->orders_count); ?></span>
                    </div>

                    <!--[if BLOCK]><![endif]--><?php if(!$table->is_active): ?>
                    ...
                    <div class="flex items-center text-sm text-blue-600">
                        ...
                        <span class="ml-2 font-medium"><?php echo e($table->activeOrder->order_number); ?></span>
                    </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                ...
                <div class="mb-4 pb-4 border-b border-gray-200 bg-blue-50 -mx-6 px-6 py-3">
                    ...
                    <div class="text-xs text-blue-700 space-y-1">
                        <div class="myanmar-text">ပစ္စည်း: <?php echo e($table->activeOrder->orderItems->count()); ?> မျိုး</div>
                        <div class="font-semibold">စုစုပေါင်း: <?php echo e(number_format($table->activeOrder->total, 0)); ?> Ks</div>
                    </div>
                    <button wire:click="viewTableOrders(<?php echo e($table->id); ?>)" class="mt-2 w-full text-xs bg-blue-600 hover:bg-blue-700 text-white py-1 px-3 rounded myanmar-text">
                        အော်ဒါ ကြည့်ရန်
                    </button>
                </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="mb-4 pb-4 border-b border-gray-200">
                    ...
                    <div class="flex space-x-2">
                        <button wire:click="changeStatus(<?php echo e($table->id); ?>, 'available')" 
                                class="flex-1 px-2 py-1 text-xs rounded <?php echo e($table->status === 'available' ? 'bg-green-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                            <span class="myanmar-text">ရရှိနိုင်သော</span>
                        </button>
                        <button wire:click="changeStatus(<?php echo e($table->id); ?>, 'reserved')" 
                                class="flex-1 px-2 py-1 text-xs rounded <?php echo e($table->status === 'reserved' ? 'bg-yellow-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                ...
                <div class="flex justify-end space-x-2">
                    <button wire:click="toggleActive(<?php echo e($table->id); ?>)" class="text-blue-600 hover:text-blue-900" title="အခြေအနေ ပြောင်းရန်">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </button>
                    <button wire:click="edit(<?php echo e($table->id); ?>)" class="text-indigo-600 hover:text-indigo-900" title="ပြင်ဆင်ရန်">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                    </button>
                    <button wire:click="confirmDelete(<?php echo e($table->id); ?>)" class="text-red-600 hover:text-red-900" title="ဖျက်ရန်">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900 myanmar-text">
                    <?php echo e($editMode ? 'စားပွဲ ပြင်ဆင်ရန်' : 'စားပွဲအသစ် ထည့်ရန်'); ?>
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/admin/tables-management.blade.php ENDPATH**/ ?>