            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm font-medium text-gray-900 myanmar-text">{{ $item->name_mm }}</div>
                            <div class="text-sm text-gray-500">{{ $item->name }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900 myanmar-text">{{ $item->category->name_mm }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-2">
                                <button wire:click="toggleAvailability({{ $item->id }})" class="text-blue-600 hover:text-blue-900" title="ရရှိနိုင်မှု ပြောင်းရန်">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                </button>
                                <button wire:click="edit({{ $item->id }})" class="text-indigo-600 hover:text-indigo-900" title="ပြင်ဆင်ရန်">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                </button>
                                <button wire:click="confirmDelete({{ $item->id }})" class="text-red-600 hover:text-red-900" title="ဖျက်ရန်">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="px-6 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <img src="{{ $image->temporaryUrl() }}" class="mt-2 h-40 w-40 object-cover rounded-lg border-2 border-gray-200">
                        </div>
                        @elseif($editMode && $existingImage)
                        <div class="mt-2">
                            <p class="text-sm text-gray-500 myanmar-text">လက်ရှိ ပုံ:</p>
                            <img src="{{ Storage::url($existingImage) }}" class="mt-2 h-40 w-40 object-cover rounded-lg border-2 border-gray-200">
                        </div>
                        @endif
                    </div>
