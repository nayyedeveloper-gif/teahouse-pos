                ...
                <?php else: ?>
                            ...
                            <div class="flex items-start justify-between mb-2">
                                <div class="flex items-center space-x-3">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php if(strtoupper($log['level']) === 'ERROR'): ?> bg-red-100 text-red-800
                                        <?php elseif(strtoupper($log['level']) === 'WARNING'): ?> bg-yellow-100 text-yellow-800
                                        <?php elseif(strtoupper($log['level']) === 'INFO'): ?> bg-blue-100 text-blue-800
                                        <?php else: ?> bg-gray-100 text-gray-800
                                        <?php endif; ?>">
                                        <?php echo e(strtoupper($log['level'])); ?>

                                    </span>
                                    <span class="text-xs text-gray-500 font-mono"><?php echo e($log['environment']); ?></span>
                                </div>
                                <span class="text-xs text-gray-500 font-mono"><?php echo e($log['timestamp']); ?></span>
                            </div>
                            <div class="text-sm text-gray-700 font-mono bg-gray-50 p-3 rounded overflow-x-auto">
                                <pre class="whitespace-pre-wrap break-words"><?php echo e($log['message']); ?></pre>
                            </div>
                        </div>
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Showing <span class="font-medium"><?php echo e(($currentPage - 1) * $perPage + 1); ?></span> 
                            to <span class="font-medium"><?php echo e(min($currentPage * $perPage, $total)); ?></span> 
                            of <span class="font-medium"><?php echo e($total); ?></span> logs
                        </div>
                        
                        <!--[if BLOCK]><![endif]--><?php if($lastPage > 1): ?>
                        <div class="flex space-x-2">
                            <!--[if BLOCK]><![endif]--><?php if($currentPage > 1): ?>
...
<?php /**PATH /Users/developer/Downloads/teahouse-pos/resources/views/livewire/admin/error-logs.blade.php ENDPATH**/ ?>